...
# Licence:     not opensource  ver.0.03
#-------------------------------------------------------------------------------
# import librerie
import os
import csv
...
#funzione di lettura della mail list.
    ...
    for i, listacsv in enumerate (solo_csv,start=1):
        print i, listacsv ,"\n"
...
def caricamentopagina (percorso):
    ...
    for i, listahtml in enumerate (solo_html,start=1):
        print i, listahtml,"\n"
...
#scelta foto
        ...
        for i, listafoto in enumerate (solo_foto,start=1):
            print i, listafoto, '\n'
